...
if grep -sq 40600 $file && grep -sqv 40650 $file ; then
    ...
    curl -s -u forecastuser:r1SuN4MsNf -H "Content-Type: text/csv" -X POST --data-binary "@$refile" http://localhost:8080/dms/api/nrwbwq/components/forecasts/publishTesting
else
