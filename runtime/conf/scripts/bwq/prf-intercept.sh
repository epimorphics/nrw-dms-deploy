...
#    CEMAES_SNS_TOPIC=arn:aws:sns:eu-west-1:853478862498:dave_epimorphics_com
    aws sns publish --topic-arn $CEMAES_SNS_TOPIC --subject "Cemaes forecast" --message "EA Forecast for Cemaes: $CEMAES_PRF"
  fi
