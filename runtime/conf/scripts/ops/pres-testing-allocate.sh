...
# Work out query endpoint for production data tier - will need changing if we start having testing data servers as well
LB_DNS=$( jq -r .DNSName $serverDir/../../../../../production/tiers/dataservers/aws-lb.json )
